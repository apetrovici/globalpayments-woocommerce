( function (
	...
	GooglePayWoocommerce.prototype = {
		...
		getBtnColor: function () {
			//@TODO - rename button_color to btn_color
			return this.gatewayOptions.button_color ;
		},

		getAllowedCardNetworks: function () {
			console.log('getAllowedCardNetworks...', this.gatewayOptions.cc_types);
			//@TODO - rename accepted_cards to card_types
		...
		onGooglePaymentButtonClicked : function () {
			...
			this.paymentsClient.loadPaymentData( paymentDataRequest )
				.then( function ( paymentData ) {
					// @TODO helper - create input element
					helper.createInputElement(
						self.id,
						'digital_wallet_token_response',
						//@TODO check the value old code: JSON.stringify( JSON.parse( token ) );
				...
				.catch( function ( err ) {
					console.error( err );
					//@TODO helper.unblockOnError();
				});
		},

		// @TODO check if in helper?
